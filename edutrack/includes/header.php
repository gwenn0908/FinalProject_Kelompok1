...
<head>
    ...
    <link rel="stylesheet" href="/edutrack/assets/css/main.css">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                <div class="sidebar-main">
                    ...
                    <a href="calendar.php" class="sidebar-link <?php echo (basename($_SERVER['PHP_SELF']) == 'calendar.php') ? 'active' : ''; ?>">
                        <i class="fas fa-calendar-alt"></i>
                        <span>Calendar</span>
                    </a>
                    <a href="notes.php" class="sidebar-link <?php echo (basename($_SERVER['PHP_SELF']) == 'notes.php') ? 'active' : ''; ?>">
